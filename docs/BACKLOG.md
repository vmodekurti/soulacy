...
| 2 | M3 Sidecar foundation | **E3 → E4 → E5 → E6 → E7 → E8** | E3 ✅ E4 ✅ E5 ✅ E6 ✅ E7 ✅ (protocol v1, supervised lifecycle, principals/capabilities, credential delegation, manifest v2 w/ sidecar channels + providers + skills + GUI parse, wired in main.go; docs/PLUGIN_MANIFEST.md). E8 next: plugin GUI mounts + scoped tokens. |

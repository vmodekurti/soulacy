...
| 6 | M6 SDK & distribution | **E9 → E10 → E15 → E16 → E17 → E11 → E12 → E13** | E9 ✅, E10 ✅ (registry-routed built-ins + internal/app composition root; main.go is a 52-line shell), E15 ✅ (sdk/reasoning Strategy contract, RegisterReasoningStrategy, react/plan_execute registered, custom-loop conformance test, docs/REASONING_STRATEGIES.md). NEXT: E16 → E17 → E11 → E12 → E13 (see SESSION_HANDOFF). |

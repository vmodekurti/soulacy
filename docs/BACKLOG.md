...
| 6 | M6 SDK & distribution | **E9 → E10 → E15 → E16 → E17 → E11 → E12 → E13** | E9 ✅, E10 ✅ (all parts: sdk/registry factories, init() self-registration of all built-ins + generated blank-import file, internal/app composition root — main.go is a 52-line shell). NEXT: E15 → E16 → E17 → E11 → E12 → E13 (see SESSION_HANDOFF). |

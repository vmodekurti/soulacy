...
| 6 | M6 SDK & distribution | **E9 → E10 → E15 → E16 → E17 → E11 → E12 → E13** | E9 ✅, E10 part 1 ✅ (SDK + sdk/registry factory registries w/ strangler fallback semantics). E10 next: register built-ins + resolve config via registry, then internal/app extraction (see SESSION_HANDOFF for the step plan). E15–E17 follow. |

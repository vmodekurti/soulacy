...
| 2 | M3 Sidecar foundation | **E3 → E4 → E5 → E6 → E7 → E8** | E3 ✅ E4 ✅ E5 ✅ E6 ✅ (protocol v1 + adapter + conformance + supervised lifecycle + plugin principals/capabilities + vault credential delegation w/ rotation restart; docs/PLUGIN_CAPABILITIES.md, docs/PLUGIN_CREDENTIALS.md). E7 next: manifest v2. |

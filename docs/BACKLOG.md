...
| 2 | M3 Sidecar foundation | **E3 → E4 → E5 → E6 → E7 → E8** | E3 ✅ E4 ✅ E5 ✅ (protocol v1 + generic adapter + conformance + supervised lifecycle + plugin principals/capabilities w/ default-deny enforcement + audit; docs/PLUGIN_CAPABILITIES.md). E6 next: vault credential delegation. |
